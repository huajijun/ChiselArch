...
#endif
#include <iostream>
class BrCondSimple_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    BrCondSimple_api_t(VBrCondSimple* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
...
static BrCondSimple_api_t * _Top_api;
...
int main(int argc, char **argv, char **env) {
    ...
    VBrCondSimple* top = new VBrCondSimple;
    std::string vcdfile = "test_run_dir/BrCondTest2134473989/BrCondSimple.vcd";

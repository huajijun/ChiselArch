...
#endif
#include <iostream>
class Accum_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    Accum_api_t(VAccum* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["Accum.reset"] = 0;
    }
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/AccumTest28054975/Accum.vcd";

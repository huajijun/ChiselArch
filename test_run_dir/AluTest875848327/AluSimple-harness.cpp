...
#endif
#include <iostream>
class AluSimple_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    AluSimple_api_t(VAluSimple* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
...
static AluSimple_api_t * _Top_api;
...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/AluTest875848327/AluSimple.vcd";

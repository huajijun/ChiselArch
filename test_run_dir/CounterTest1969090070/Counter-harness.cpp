...
class Counter_api_t: public sim_api_t<VerilatorDataWrapper*> {
    ...
    void init_sim_data() {
        ...
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_amt)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_inc)));
        sim_data.outputs.push_back(new VerilatorCData(&(dut->io_tot)));
...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/CounterTest1969090070/Counter.vcd";
